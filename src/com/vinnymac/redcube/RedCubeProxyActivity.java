...
public class RedCubeProxyActivity extends Activity
{
	protected void onCreate (Bundle savedInstanceState)
	{
		...
		String classNames[] = { "com.vinnymac.redcube.RedCubeActivity", "com.vinnymac.redcube.RedCubeNativeActivity" };
